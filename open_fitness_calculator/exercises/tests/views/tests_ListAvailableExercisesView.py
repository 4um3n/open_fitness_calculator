...
class ListAvailableExercisesViewTests(TestCase):
    __USER__MODEL = get_user_model()
    __EXERCISE_MODEL = Exercise
    __VALID_TEMPLATE_NAME = "exercises/list_available_exercises.html"
    __VALID_URL = None
    ...
    def setUp(self) -> None:
        ...
        url_kwargs = {"diary_pk": self.diary.pk}
        self.__VALID_URL = reverse("list available exercises", kwargs=url_kwargs)
